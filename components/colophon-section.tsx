  ...
  return (
    ...
    >
      ...
      <div ref={headerRef} className="mb-16">
        ...
        <h2 className="mt-4 text-5xl md:text-7xl tracking-tight">CONTACT ME</h2>
      </div>
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="mailto:adandreidan@gmail.com"
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">April 2030</li>
